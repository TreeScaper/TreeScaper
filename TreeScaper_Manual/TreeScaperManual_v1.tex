...
Model (CNM) or Erdos-Rényi Null Model (ERNM) are used and the trees are fully
...
When detecting communities (-o Community):
	...
	\item[-cm:] Model used to compute communities. Options are:
		...
		\item[`ERNM':] Erdos-Rényi Null Model
